...
public class RoomGenerationTestBootstrap : MonoBehaviour
{
    ...
    [SerializeField] private int kitchenVisualMinimumSortingOrder = 10;
    ...
    private void EnsureKitchenVisual(ProceduralRoomLayout room, bool visible)
    {
        ...
        visual.sortingOrder = Mathf.Max(kitchenVisualSortingOrder + 3, kitchenVisualMinimumSortingOrder);
